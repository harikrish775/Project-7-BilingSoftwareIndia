...
urlpatterns = [
    ...
    path('party_save_gstcheck_ajax',views.party_save_gstcheck_ajax,name="party_save_gstcheck_ajax"),
    path('party_edit_namecheck_ajax/<int:pk>',views.party_edit_namecheck_ajax,name="party_edit_namecheck_ajax"),
