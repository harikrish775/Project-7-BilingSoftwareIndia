# Generated by Django 4.2.6 on 2024-04-22 05:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(null=True)),
                ('company', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='app.company')),
            ],
        ),
        migrations.CreateModel(
            name='party',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.company')),
                ('party', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.parties')),
            ],
        ),
        migrations.CreateModel(
            name='purchasedebit',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='app.company')),
                ('convert_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.purchasebill')),
                ('party', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='app.party')),
            ],
        ),
        migrations.CreateModel(
            name='SalesInvoice',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.company')),
                ('item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.itemmodel')),
                ('salesinvoice', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.salesinvoice')),
                ('staff', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.staff_details')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='staff',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.staff_details'),
        ),
        migrations.AddField(
            model_name='salesinvoice',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.company')),
                ('purchaseorder', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.purchaseorder')),
                ('staff', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.staff_details')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.itemmodel')),
                ('purchaseorder', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.purchaseorder')),
            ],
        ),
        migrations.AddField(
            ...
            name='staff',
            field=models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='app.staff_details'),
        ),
        migrations.CreateModel(
            name='purchasedebit1',
            fields=[
                ...
                ('pdebit', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.purchasedebit')),
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.itemmodel')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transactiondate', models.DateField(auto_now=True)),
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.company')),
                ('purchasebill', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.purchasebill')),
                ('staff', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.staff_details')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.company')),
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.itemmodel')),
                ('purchasebill', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.purchasebill')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='parties',
            name='staff',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='app.staff_details'),
        ),
        migrations.CreateModel(
            name='modules_list',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(max_length=255)),
                ('date', models.DateField(default=datetime.date(2024, 4, 22))),
                ('company', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='app.company')),
                ('party', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='app.parties')),
                ('staff', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='app.staff_details')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transactiondate', models.DateField(auto_now=True)),
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.company')),
                ('debitnote', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.purchasedebit')),
                ('staff', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.staff_details')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.company')),
                ('credit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.creditnote')),
                ('item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.itemmodel')),
                ('staff', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='app.staff_details')),
            ],
        ),
        ...
        migrations.AddField(
            ...
            name='item',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.itemmodel'),
        ),
        migrations.AddField(
            model_name='creditnote',
            name='party',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.parties'),
        ),
        migrations.AddField(
            model_name='creditnote',
            name='salesinvoice',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.salesinvoice'),
        ),
        migrations.AddField(
            model_name='creditnote',
            name='staff',
